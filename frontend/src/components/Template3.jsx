...
import { Box, Typography, Paper, Grid2, Divider, Chip, Button} from "@mui/material"
...
const Template3 = () => {
  ...
  return (
    ...
    <Paper id='container2' elevation={3} sx={{ p: 4, maxWidth: 800, mx: "auto", my: 4, backgroundColor: "#e8f5e9" }}>
